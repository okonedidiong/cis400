...
def main():
    ...
    comments = comments[4000:4025]
    comments = ". ".join(comments)
    #print(comments)
    summary = extract_sentences(comments, summary_length=25, clean_sentences=False, language='english')
    #phrases = extract_key_phrases(comments)
    print(summary)
    #print()
